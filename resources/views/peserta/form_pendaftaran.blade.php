        ...
        <div class="conten">
            <div class="bungkus">
                ...
                <form method="post" action="/peserta/form_pendaftaran" enctype="multipart/form-data">
                    ...
                    <input type="text" class="nama_pendaftar" id="nama_pendaftar" placeholder="Masukan Nama" name="nama_pendaftar" value="{{ auth()->user()->pendaftaran->nama_pendaftar}}" disabled required>

                    <input type="text" class="asal_daerah" id="asal_daerah" placeholder="Masukan Asal Daerah" name="asal_daerah" value="{{ old('asal_daerah') }}" required>

                    <input type="text" class="asal_univ_pendaftar" id="asal_univ_pendaftar" placeholder="Masukan Asal Universitas" name="asal_univ_pendaftar" value="{{ auth()->user()->pendaftaran->asal_univ_pendaftar}}" disabled required>

                    <input type="email" class="email_pendaftar" id="email_pendaftar" placeholder="Masukan Email" name="email_pendaftar" value="{{ auth()->user()->pendaftaran->email_pendaftar}}" disabled required>

                    <input type="number" class="no_telepon_pendaftar" id="no_telepon_pendaftar" placeholder="Masukan Nomor Telepon" name="no_telepon_pendaftar" value="{{ old('no_telepon_pendaftar') }}" required>

                    <input type="text" class="id_line_pendaftar" id="id_line_pendaftar" placeholder="Masukan ID Line" name="id_line_pendaftar" value="{{ old('id_line_pendaftar') }}">
